 ...
 * @author ZjxMi
 */
@TableName(value = "at_users_collect")
@Data
public class AtUsersCollect extends BasePojo implements Serializable {
    private static final long serialVersionUID = 7354661854296674259L;
    ...
    public JSONObject getEnumsJson() {
        ...
        AtUsersCollectEnum[] enumsArr = AtUsersCollectEnum.values();
        for (AtUsersCollectEnum enumsTemp : enumsArr) {
