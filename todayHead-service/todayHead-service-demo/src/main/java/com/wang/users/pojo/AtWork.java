 ...
 * @author ZjxMi
 */
@TableName(value = "at_work")
@Data
public class AtWork extends BasePojo implements Serializable {
    private static final long serialVersionUID = -4983153209668388992L;
    ...
    public JSONObject getEnumsJson() {
        ...
        AtWorkEnum[] enumsArr = AtWorkEnum.values();
        for (AtWorkEnum enumsTemp : enumsArr) {
